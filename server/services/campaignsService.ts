...
export async function createCampaign(input: {
  ...
  // No fluxo por CNPJ (importedLeadIds) os leads já foram criados no import,
  // então pula a materialização por telefone.
  if (!input.audienceFilter.importedLeadIds?.length) {
