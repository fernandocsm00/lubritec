...
import type { PublicLead, LeadStatus, LeadSource, LeadFlowStage, CadastroStage, LeadEnrichmentResult, LeadQualityFeedback, LeadCampaignSummary, Imbp, Segment, Uf } from '@shared/types';
